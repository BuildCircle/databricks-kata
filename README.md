...
### Prerequisites
*   Access to Build Circles Free edition databricks cluster [here](https://login.databricks.com/). Sign in with the databricks@buildcircle.co.uk email address, your interview buddy can provide the access code.
